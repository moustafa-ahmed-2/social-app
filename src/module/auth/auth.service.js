...
var user_repository_1 = require("./../../DB/model/user/user.repository");
...
var AuthService = /** @class */ (function () {
    function AuthService() {
        ...
        this.authFactoryService = new factory_1.AuthFactorySercice();
        this.register = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var registerDTO, userExist, user, createUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        user = this.authFactoryService.register(registerDTO);
